...
def main(master):
    ...
    Label(rt, text="Basic Calculator").pack(anchor="n")
    ...
    Button(KPD_SUP, text="\u0025", command=lambda: insertKey("%", inp), height=1, width=3, bg="#ffffff").pack(side=LEFT)
    Button(KPD_SUP, text="\u00F7", command=lambda: insertKey("\u00F7", inp), height=1, width=3, bg="#ff9900").pack(side=LEFT)
    ...
    Button(KPD_TOP, text="\u00D7", command=lambda: insertKey("\u00D7", inp), height=1, width=3, bg="#ff9900").pack(side=LEFT)
    ...
    Button(KPD_MID, text="\u2212", command=lambda: insertKey("\u2212", inp), height=1, width=3, bg="#ff9900").pack(side=LEFT)
    ...
    Button(KPD_BOT, text="\u002B", command=lambda: insertKey("\u002B", inp), height=1, width=3, bg="#ff9900").pack(side=LEFT)
